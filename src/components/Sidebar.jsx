    ...
    <div className="fixed left-0 top-0 h-full flex flex-col justify-start items-center px-1 max-w-[68px] bg-white border border-solid border-zinc-400">
      <div className="flex flex-col items-center pt-2 pb-6">
        ...
        <img
          ...
          className="mt-11 w-9 aspect-[0.9] hover:bg-gray-200 cursor-pointer"
        />
        </Link>
        <Link to="/invitations">
        <img
          ...
          className="mt-14 w-9 aspect-[0.9] hover:bg-gray-200 cursor-pointer"
        />
        </Link>
        <Link to="/settings">
        <img
          ...
          className="mt-16 w-9 aspect-[0.9] hover:bg-gray-200 cursor-pointer"
        />
        </Link>
      </div>
      <div className="mt-auto mb-12">
        <img
          ...
          className="mt-64 aspect-square w-[29px] hover:bg-gray-200 cursor-pointer"
